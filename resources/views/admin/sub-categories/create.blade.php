...
@section('content')
    <div class="row">
        <div class="col-md-12">
            ...
            <ul class="page-breadcrumb breadcrumb">
                ...
                <li>
                    <a href="#">Add New Sub Categories</a>
                </li>
            </ul>
        </div>
    </div>
    <div class="portlet box blue">
        <div class="portlet-title">
            <div class="caption">
                <i class="fa fa-plus"></i>Add New Sub Categories
            </div>
        </div>
            ...
            <form action="#" onsubmit="return false;" id="form_sample_2" class="form-horizontal">
                ...
                <div class="form-body">
                    ...
                    <div class="alert alert-success display-hide">
                        <button class="close" data-close="alert"></button>
                       Sub Category is added successful!
                    </div>
                    ...
                    <div class="form-group">
                        <label class="control-label col-md-3">Sub Category Image <span class="required">
                        * </span>
                        </label>
                        <div class="col-md-4">
                            <div class="input-icon right">
                    ...
                    <div class="form-group">
                        ...
                        <div class="">
                            <div class="input-icon right">
                                <i class="fa"></i>
                                <input type="checkbox" class="form-control" name="is_head" value="1" />Are you want to show in Header<span class="required">
                                * </span>
                            </div>
                        </div>
                        </label>
    ...
    var handleValidation2 = function() {
            ...
            form2.validate({
                ...
                submitHandler: function (form) {
                    ...
                    $.ajax({
                        type: 'POST',
                        url: '{{ url("admin/sub-categories/store") }}',
                        data: formData,
                        cache       : false,
                        contentType : false,
                        processData : false,
