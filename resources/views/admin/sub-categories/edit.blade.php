...
@section('content')
    ...
    <div class="portlet box blue">
        <div class="portlet-title">
            <div class="caption">
                <i class="fa fa-plus"></i>Edit Sub Categories
            </div>
        </div>
            ...
            <form action="#" onsubmit="return false;" id="form_sample_2" class="form-horizontal">
                ...
                <div class="form-body">
                    ...
                    <div class="alert alert-success display-hide">
                        <button class="close" data-close="alert"></button>
                        Sub Category is updated successful!
                    </div>
                    ...
                    <div class="form-group">
                        ...
                        * </span>
                        ...
                        <div class="col-md-4">
                            <img src="{{ $subcategory['image'] }}" width="200px" height="200px">
                        </div>
                    </div>
                    <div class="form-group">
                        ...
                        <div class="">
                            <div class="input-icon right">
                                <i class="fa"></i>
                                <input type="checkbox" <?=$subcategory['is_header']?'checked':""?> class="form-control" name="is_head"/>Are you want to show in Header<span class="required">
                                * </span>
                            </div>
                        </div>
                        </label>
...
$('#sub-category').addClass('active open');
$('#sub-category #link' ).append('<span class="selected"></span>');
$('#sub-category #link .arrow' ).addClass('open');
$('#add-sub-category').addClass('active');
</script>
    ...
    var handleValidation2 = function() {
            ...
            form2.validate({
                ...
                submitHandler: function (form) {
                    ...
                    $.ajax({
                        type: 'POST',
                        url: '{{ url("admin/sub-categories/update") }}/{{ $subcategory["id"] }}',
                        data: formData,
                        cache       : false,
                        contentType : false,
                        processData : false,
