        ...
        <div class="col-md-12">
            <div class="portlet box purple">
                <div class="portlet-title">
                    <div class="caption">
                        <i class="fa fa-cogs"></i>Categories List
                    </div>
                    <div class="actions">
                        ...
                        <tbody>
                            @if(isset($categories))
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <a href="{{url('admin/categories/delete')}}/{{$row->id}}" class="btn-sm btn-danger">
                                            <i class="fa fa-trash-o"></i>
                                        </a>&nbsp;
                                        <a href="{{url('admin/categories/edit')}}/{{$row->id}}" class="btn-sm btn-primary">
