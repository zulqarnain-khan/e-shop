        ...
        <div class="col-md-12">
            <div class="portlet box yellow">
                <div class="portlet-title">
                    <div class="caption">
                        <i class="fa fa-cogs"></i>Brand List
                    </div>
                    <div class="actions">
                            ...
                            @if(isset($brands))
                                ...
                                <tr>
                                   ...
                                   <td> {{$row->subcategory->name}} </td>
                                    ...
                                    <td>
                                        <a href="{{url('admin/brands/delete')}}/{{$row->id}}" class="btn-sm btn-danger">
                                            <i class="fa fa-trash-o"></i>
                                        </a>&nbsp;
                                        <a href="{{url('admin/brands/edit')}}/{{$row->id}}" class="btn-sm btn-primary">
