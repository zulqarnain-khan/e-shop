        ...
        <div class="row">
          ...
          <div class="col-md-3 col-sm-6 pre-footer-col">
            ...
            <address class="margin-bottom-40">
              1st Floor, Office#33, IT Tower, <br>
              73-E-1, Hali Road, Gulberg 3, Lahore, <br>
              Block E 1 Gulberg III, Lahore, <br> 
              Punjab 54810<br>
              Phone: +97156-8242941<br>
              Email: <a href="mailto:info@metronic.com">ecommerce@techcreatix.com</a><br>
            </address>
          </div>
          <!-- END BOTTOM CONTACTS -->
        </div>
      ...
      <div class="container">
        <div class="row">
          ...
          <div class="col-md-6 col-sm-6 padding-top-10">
            2020 © Tech Creatix. ALL Rights Reserved. 
          </div>
          <!-- END COPYRIGHT -->
          <!-- BEGIN PAYMENTS -->
          <div class="col-md-6 col-sm-6">
